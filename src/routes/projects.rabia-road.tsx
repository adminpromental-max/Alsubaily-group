...
export const Route = createFileRoute("/projects/rabia-road")({
  head: () => ({
    meta: [
      {
        title: "رابية رود — مجموعة الشبيلي | Rabia Road",
      },
      {
        name: "description",
        content:
          "رابية رود — واجهة مكة الغربية على طريق مكة جدة السريع. 2,450,000 م² على بعد دقائق من الحرم المكي الشريف.",
      },
      {
        property: "og:title",
        content: "Rabia Road — AlShubaily Group",
      },
      {
  ...
  component: RabiaRoadPage,
});

function RabiaRoadPage() {
  return (
