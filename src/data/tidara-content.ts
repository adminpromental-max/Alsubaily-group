...
export const TIDARA_INTRO = {
  ...
  image: tidaraAsset("11.png"),
  imageAltAr: "المخطط العام لأبراج تيدارا",
...
export const TIDARA_GALLERY: TidaraGalleryItem[] = [
  {
    id: "img-1",
    image: tidaraAsset("1.png"),
    tagAr: "منظور خارجي",
    tagEn: "Exterior View",
    altAr: "أبراج تيدارا — منظور خارجي",
    altEn: "Tidara Towers — exterior view",
    descAr: "وجهة ساحلية على مارينا الخبر",
    descEn: "Coastal destination on Al Khobar marina",
  },
  {
    id: "img-2",
    image: tidaraAsset("2.png"),
    tagAr: "واجهة معمارية",
    tagEn: "Architectural Façade",
    altAr: "أبراج تيدارا — واجهة معمارية",
    altEn: "Tidara Towers — architectural façade",
    descAr: "تصميم بارامتري يربط البوديوم بالبرج والمارينا",
  ...
  },
  {
    ...
    tagEn: "Coastal Promenade",
    altAr: "أبراج تيدارا — الممشى الساحلي",
    altEn: "Tidara Towers — coastal promenade",
    descAr: "ممشى عام ينشّط الواجهة ويحوّلها إلى حياة يومية",
    descEn: "Public promenade activating the waterfront daily",
  },
  {
    id: "img-5",
    image: tidaraAsset("5.png"),
    tagAr: "مخطط عام",
    tagEn: "Master Plan",
    altAr: "أبراج تيدارا — المخطط العام",
    altEn: "Tidara Towers — master plan",
    descAr: "تخطيط متكامل يربط الفندق والإداري والسكني",
    descEn: "Integrated layout linking hotel, admin, and residential",
  },
  {
    id: "img-6",
    image: tidaraAsset("6.png"),
    tagAr: "تصور ثلاثي الأبعاد",
    tagEn: "3D Visualization",
    altAr: "أبراج تيدارا — تصور ثلاثي الأبعاد",
    altEn: "Tidara Towers — 3D visualization",
    descAr: "برج مركزي بإطلالة بانورامية على الخليج",
    descEn: "Central tower with panoramic Gulf views",
  },
  {
    id: "img-7",
    image: tidaraAsset("7.png"),
    tagAr: "سكني",
    tagEn: "Residential",
    altAr: "أبراج تيدارا — الوحدات السكنية",
    altEn: "Tidara Towers — residential units",
    descAr: "63+ وحدة سكنية بمساحات 110–156 م²",
    descEn: "63+ units of 110–156 m²",
  },
  {
    id: "img-8",
    image: tidaraAsset("8.png"),
    ...
    altAr: "أبراج تيدارا — البرج الإداري",
    altEn: "Tidara Towers — administrative tower",
    descAr: "116 مكتباً بمساحة 160 م² وSky Lounge",
    descEn: "116 offices at 160 m² each and a Sky Lounge",
  },
  {
    id: "hotel",
    image: tidaraAsset("Hotel.png"),
    ...
    descAr: "مبنى فندقي G+11 بإطلالة على المارينا والخليج",
    descEn: "G+11 hotel with marina and Gulf views",
  },
  {
    id: "img-9",
    image: tidaraAsset("9.png"),
    tagAr: "جولة بصرية",
    tagEn: "Walkthrough",
    altAr: "أبراج تيدارا — جولة بصرية",
    altEn: "Tidara Towers — visual walkthrough",
    descAr: "منظور خارجي يُظهر العلاقة بين المباني والمارينا",
    descEn: "Exterior perspective showing buildings and marina",
  },
  {
    id: "img-10",
    image: tidaraAsset("10.png"),
    tagAr: "منظر ليلي",
    tagEn: "Night View",
    altAr: "أبراج تيدارا — منظر ليلي",
    altEn: "Tidara Towers — night view",
    descAr: "تصور ليلي يُبرز الإضاءة المعمارية على الواجهة البحرية",
    descEn: "Night rendering highlighting architectural lighting",
  },
  {
    id: "img-11",
    image: tidaraAsset("11.png"),
    tagAr: "تفاصيل معمارية",
    tagEn: "Architectural Details",
    altAr: "أبراج تيدارا — تفاصيل معمارية",
