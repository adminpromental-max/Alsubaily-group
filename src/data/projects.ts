...
export type Project = {
  ...
  heroImage: string;
  gallery: string[];
  /** Shows قريباً badges and coming-soon project page */
  comingSoon?: boolean;
};
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    heroImage: dammamAsset("cover.jpg"),
    gallery: [
  ...
  },
  {
    ...
    gallery: [
      ...
      alshubailyResidenceAsset("الشبيلي ريزيدنس صور /1.png"),
      alshubailyResidenceAsset("الشبيلي ريزيدنس صور /7.png"),
    ],
  },
  {
    id: 7,
