  ...
  return (
    <main className="relative flex min-h-[100svh] flex-col overflow-hidden bg-[#1A1410]">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-8 text-center">
          <div>
            <p className="mb-4 flex items-center justify-center gap-2 text-xs font-medium uppercase tracking-[0.35em] text-[#F5D4B8]">
          ...
          <div className="w-full max-w-md rounded-3xl border border-[#D4854A]/30 bg-[#1A1410]/70 px-8 py-10 backdrop-blur-md md:px-12 md:py-11">
            <p className="font-heading text-2xl font-bold leading-snug text-[#F5D4B8] md:text-3xl">
