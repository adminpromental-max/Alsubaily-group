...
export function InteractiveMap() {
  ...
  const panelView: "none" | "region" | "project" = activeProject
    ? "project"
    : mapMode === "region" && activeRegion
      ? "region"
      : "none";
  ...
  return (
    <div className="relative w-full">
      <div className="flex flex-col gap-4 px-2 md:flex-row md:items-start md:px-4 lg:px-6">
        <div className="min-w-0 flex-1">
          <div
            className={cn(
              "relative w-full transition-opacity duration-300",
              "h-[min(88vw,520px)] min-h-[340px] md:h-[min(82vh,820px)] md:min-h-[560px]",
        ...
        <div className="hidden shrink-0 md:block md:w-[320px] lg:w-[360px]">
          <div
...
function ProjectCardContent({
  ...
  return (
    <div className="flex min-h-0 flex-col px-4 pb-4 pt-1">
      {compact && (
        <div className="relative mb-3 h-32 overflow-hidden rounded-2xl border border-[#E0D3C2]/70 bg-[#1A1612]/5">
          <img
      ...
      <div className="mt-4 flex gap-2">
        <Link
          ...
          className={cn(
            ...
            "flex-1 rounded-full stone-surface-dark text-white hover:opacity-95",
          )}
        >
