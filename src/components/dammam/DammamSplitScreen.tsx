...
const CHAPTERS = [
  {
    ...
    bodyAr:
      "يستوعب أكثر من 45,000 متفرج ومصمم وفق أعلى المعايير الدولية لاستضافة البطولات الكبرى والفعاليات متعددة التخصصات، مع تقنيات بث متطورة وتجربة مشاهدة استثنائية.",
    bodyEn:
      "Accommodating over 45,000 spectators, designed to the highest international standards for major championships and multi-discipline events with advanced broadcast technology.",
  },
  {
    file: "2.png",
    ...
    bodyAr:
      "أكثر من 30 منشأة رياضية متخصصة — ملاعب كرة القدم، كرة السلة، السباحة، الجمباز، والرياضات المائية — كلها في موقع واحد يرسم مستقبل الرياضة في المنطقة الشرقية.",
    bodyEn:
      "Over 30 specialized sports facilities — football, basketball, swimming, gymnastics, and water sports — all within one destination shaping the future of sport.",
  },
  {
    file: "3.png",
    ...
    bodyAr:
      "مركز حضري نابض يجمع المطاعم الفاخرة، المحلات الرياضية، ومراكز التدريب الاحترافية في تجربة متكاملة تمزج الأداء الرياضي بأسلوب الحياة العصري.",
    bodyEn:
      "A vibrant urban center combining fine dining, premium sports retail, and professional training centers in an experience that blends athletic performance with modern living.",
  },
  {
    file: "4.jpg",
    ...
    bodyAr:
      "شبكة طرق ذكية، أنظمة ذكاء اصطناعي لإدارة الحشود، منظومة استدامة بيئية متكاملة، وإمكانية وصول شاملة — مدينة أولمبية مصممة لتكون مرجعاً للمستقبل.",
    bodyEn:
      "Smart road networks, AI crowd management, comprehensive environmental sustainability, and fully accessible design — an Olympic city engineered for the future.",
  },
  {
    file: "5.jpg",
    ...
    bodyAr:
      "فضاءات خضراء واسعة تُشكّل رئة المدينة الأولمبية — ممشيات الأسرة، الملاعب المفتوحة، ومناطق الاسترخاء — بيئة تجمع الطبيعة والنشاط في تصميم حضري متوازن.",
    bodyEn:
      "Vast green spaces forming the lungs of the Olympic city — family walkways, open courts, and relaxation zones — merging nature and activity in a balanced urban design.",
  },
  {
    file: "6.jpg",
    ...
    bodyAr:
      "مجمع مائي عالمي يضم حمامات السباحة الأولمبية، منصات الغطس، وملاعب الكرة المائية — مصمم ليستضيف البطولات الدولية وليكون مقصداً للمحترفين.",
    bodyEn:
      "A world-class aquatic complex with Olympic pools, diving platforms, and water polo arenas — designed to host international championships and elite athletes.",
  },
  {
    file: "7.jpg",
    ...
    bodyAr:
      "كورنيش بحري استثنائي يمتد على طول واجهة المدينة — ممشيات للدراجات والمشاة، مطاعم على الماء، وأجواء بحرية ساحرة تكتمل بها تجربة المدينة الرياضية الشاملة.",
    bodyEn:
      "An exceptional seaside corniche stretching along the city's waterfront — cycling promenades, waterside dining, and maritime ambiance completing the sports city experience.",
  },
];
...
export function DammamSplitScreen() {
  ...
  useEffect(() => {
    const frame = requestAnimationFrame(() => {
      stTriggers.current.forEach((trigger) => trigger.kill());
      stTriggers.current = [];
    ...
    <div className="dss-page overflow-x-hidden bg-[#FAF8F4]">
      <section className="dss-hero">
        ...
        <div className="dss-hero-content">
          <Link to="/projects/dammam-olympic-city" className="dss-back">
            ← {t("النسخة الكلاسيكية", "Classic View")}
          </Link>
